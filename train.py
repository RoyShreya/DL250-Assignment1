...
def train(BATCH_SIZE,D_in, H1, D_out):
    ...
    if torch.cuda.is_available():
        net=MyNet(D_in,H1,D_out)  #inp dimension and hidden dimension and output dsimension ie. numof classes here
        net=net.float()
        net=net.cuda()
